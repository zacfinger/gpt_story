# Set up cron job with conda environment
...
try:
    ...
    print("Checking that parallel process not already running")

    # Check that no rows have status 4
    mycursor.execute("SELECT * FROM Story WHERE STATUS = 4 ORDER BY Story.id ASC LIMIT 1")
    ...
    if story is None:
        ...
        # Get oldest story already scraped via SMMRY API
        ...
        print("Parallel process already running")
